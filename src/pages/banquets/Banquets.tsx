...
// }
//
// interface ISelectedItem extends IMenuItem {
//   count?: number;
// }
//
...
//   };
//
//   const getSuggestOptions = useCallback((items: Array<IMenuItem>) => items
...
//               {banquetsStore.menu.map(menuGroup => (
//                 <Grid item xs={12} key={menuGroup.name}>
//                   <MuiSuggestSelector
//                     label={menuGroup.name}
//                     onChange={(option: IMenuItem) => onChangeSnacks(option, menuGroup)}
//                     options={getSuggestOptions(menuGroup.items)}
//                   />
//                 </Grid>
//               ))}
//             </Grid>
